...
object TelemetryFrameMapper {
    ...
    private fun payloadFields(snapshot: TelemetrySnapshot): Map<String, JsonValue> = mapOf(
        ...
        "cameraFrameLastAgeMillis" to snapshot.cameraFrameLastAgeMillis.json(),
        "cameraFrameCodec" to snapshot.cameraFrameCodec?.name.json(),
        "cameraFrameWidth" to snapshot.cameraFrameWidth.json(),
        "cameraFrameHeight" to snapshot.cameraFrameHeight.json(),
        "cameraFrameRate" to snapshot.cameraFrameRate.json(),
