...
includeRelayModule(":device-connection:android-remote-controller-adapter")
includeRelayModule(":device-connection:android-aircraft-adapter")
includeRelayModule(":device-connection:dji-operation-coordinator")
includeRelayModule(":device-connection:pairing-controller")
includeRelayModule(":device-connection:pairing-status-link")
includeRelayModule(":device-connection:android-pairing-status-adapter")
includeRelayModule(":device-connection:android-pairing-command-adapter")
...
includeRelayModule(":telemetry:flight-telemetry-port")
...
includeRelayModule(":wayline-mission:mission-flight-phase")
...
includeRelayModule(":live-stream:encoded-video")
includeRelayModule(":live-stream:camera-stream-source")
includeRelayModule(":live-stream:android-camera-stream-adapter")
includeRelayModule(":live-stream:whip-stream-config")
includeRelayModule(":live-stream:whip-command-handler")
includeRelayModule(":live-stream:whip-stream-state-store")
includeRelayModule(":live-stream:whip-publisher")
includeRelayModule(":live-stream:android-whip-publisher-adapter")
includeRelayModule(":live-stream:whip-live-stream")
includeRelayModule(":live-stream:stream-config-validator")
includeRelayModule(":live-stream:stream-state-store")
includeRelayModule(":live-stream:camera-frame-observer")
...
includeRelayModule(":live-stream:android-camera-frame-observer-adapter")

includeRelayModule(":flight-control")
includeRelayModule(":flight-control:flight-command-handler")
includeRelayModule(":flight-control:dji-flight-adapter")
includeRelayModule(":flight-control:android-dji-flight-adapter")

includeRelayModule(":device-settings")
includeRelayModule(":device-settings:settings-command-handler")
...
includeRelayModule(":runtime-diagnostics:diagnostic-core")
includeRelayModule(":runtime-diagnostics:gateway-diagnostic-publisher")
includeRelayModule(":runtime-diagnostics:android-diagnostic-adapter")

includeRelayModule(":cross-runtime-e2e:simulation-dji-adapter")
includeRelayModule(":cross-runtime-e2e:relay-test-harness")
